...
if (!isset($_SESSION['user_id']) || !isset($_SESSION['name'])) {
    header("Location: register.php"); // Redirect if not registered
    exit;
}
...
$name = $_SESSION['name'];
    ...
    $stmt->execute([$user_id, $name, $identity_score, $device_score, $infra_score, $data_score, $app_score, $network_score]);
